DROP VIEW IF EXISTS inventory.v_digital_item;
CREATE OR REPLACE VIEW inventory.v_digital_item AS
SELECT
...
FROM inventory.item i
    LEFT JOIN inventory.item_file_path ifp ON ifp.item_id = i.item_id
...
ALTER VIEW inventory.v_digital_item OWNER TO store_db_su;